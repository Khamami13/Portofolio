...
export const content = {
  id: {
      ...
      categories: [
        {
          ...
          icon: "cpu",
          skills: ["Arduino", "ESP32/ESP8266", "Raspberry Pi", "MQTT", "Node-RED", "Sensor Integration", "PCB Design", "Multimeter & Oscilloscope"],
        },
        {
          name: "AI & Automation",
          icon: "bot",
          skills: ["n8n", "AI Agent", "Prompt Engineering", "LLM Integration", "RAG Pipeline", "Workflow Automation", "OpenAI API", "Ollama"],
        },
        {
          name: "Linux & DevOps",
          icon: "terminal",
          skills: ["Linux (Debian/Ubuntu/Arch)", "Docker", "Nginx", "SSH Hardening", "CI/CD", "Git", "Bash Scripting", "Monitoring Stack"],
        },
        {
          name: "DevSecOps & Pentest",
          icon: "shield",
          skills: ["Kali Linux", "Nmap", "Metasploit", "Wireshark", "Burp Suite", "OWASP", "Vulnerability Assessment", "Network Security"],
        },
        {
          name: "Vibe Coding",
          icon: "code",
          skills: ["Python", "JavaScript/TypeScript", "Next.js", "FastAPI", "REST API", "WebSocket", "Tailwind CSS", "Git Workflow"],
        },
        {
          name: "Networking",
          icon: "network",
          skills: ["MikroTik", "RouterOS", "VLAN", "Firewall Rules", "VPN", "DNS", "DHCP", "Network Monitoring"],
        },
      ],
    },
    projects: {
      ...
      items: [
        ...
        },
        {
          ...
          tags: ["Electronics", "Repair", "PCB", "SMD", "Diagnostics", "Documentation"],
          status: "Ongoing",
      ...
      items: [
        {
          ...
          description: "Eksplorasi mendalam ekosistem AI: membangun AI agent, RAG pipeline, integrasi multi-LLM, dan otomasi workflow dengan n8n. Fokus pada prompt engineering sistematis.",
          tags: ["AI", "n8n", "LLM", "Automation"],
        },
        {
          year: "2023–2024",
          title: "DevSecOps & Linux Hardening",
          description: "Membangun home lab dengan pendekatan DevSecOps: implementasi CI/CD, container security, vulnerability scanning, dan Linux pentest environment dengan Kali.",
          tags: ["DevSecOps", "Linux", "Docker", "Security"],
        },
        {
          year: "2022–2023",
          title: "Network Engineering & MikroTik",
          description: "Memperdalam MikroTik RouterOS: konfigurasi VLAN, firewall, QoS, VPN, dan monitoring jaringan. Mulai otomasi tugas jaringan dengan scripting.",
          tags: ["MikroTik", "Networking", "RouterOS", "VPN"],
        },
        {
          year: "2020–2022",
          title: "IoT & Embedded Systems",
          description: "Membangun proyek IoT dengan ESP32/ESP8266, Arduino, Raspberry Pi. Integrasi sensor, MQTT, Node-RED, dan dashboard monitoring real-time.",
          tags: ["IoT", "ESP32", "Arduino", "MQTT"],
        },
        {
          year: "2019–2020",
          title: "Electronics & Hardware",
          description: "Fondasi kuat di elektronika dasar: membaca skema, troubleshooting komponen, soldering SMD, penggunaan osiloskop dan multimeter digital.",
    ...
    contact: {
      ...
      links: [
        { label: "LinkedIn", icon: "linkedin", url: "https://linkedin.com/in/rizqikhamami", hint: "Koneksi profesional" },
        { label: "GitHub", icon: "github", url: "https://github.com/rizqikhamami", hint: "Lihat kode saya" },
        { label: "Email", icon: "mail", url: "mailto:rizqi@example.com", hint: "Kirim pesan langsung" },
      ],
  ...
  en: {
      ...
      items: [
        {
          year: "2024–Now",
          title: "AI Agent & Prompt Engineering",
          description: "Deep exploration of the AI ecosystem: building AI agents, RAG pipelines, multi-LLM integration, and workflow automation with n8n. Focus on systematic prompt engineering.",
          tags: ["AI", "n8n", "LLM", "Automation"],
        },
        {
          year: "2023–2024",
          title: "DevSecOps & Linux Hardening",
          description: "Built a home lab with a DevSecOps approach: CI/CD implementation, container security, vulnerability scanning, and a Linux pentest environment with Kali.",
          tags: ["DevSecOps", "Linux", "Docker", "Security"],
        },
        {
          year: "2022–2023",
          title: "Network Engineering & MikroTik",
          description: "Deepened MikroTik RouterOS knowledge: VLAN configuration, firewall, QoS, VPN, and network monitoring. Started automating network tasks with scripting.",
          tags: ["MikroTik", "Networking", "RouterOS", "VPN"],
        },
        {
          year: "2020–2022",
          title: "IoT & Embedded Systems",
          description: "Built IoT projects with ESP32/ESP8266, Arduino, Raspberry Pi. Sensor integration, MQTT, Node-RED, and real-time monitoring dashboards.",
          tags: ["IoT", "ESP32", "Arduino", "MQTT"],
        },
        {
          year: "2019–2020",
          title: "Electronics & Hardware",
          description: "Strong foundation in basic electronics: reading schematics, component troubleshooting, SMD soldering, and using digital oscilloscopes and multimeters.",
          tags: ["Electronics", "Hardware", "PCB", "Repair"],
        },
      ],
    },
    ...
    contact: {
      ...
      links: [
        { label: "LinkedIn", icon: "linkedin", url: "https://linkedin.com/in/rizqikhamami", hint: "Professional connection" },
        { label: "GitHub", icon: "github", url: "https://github.com/rizqikhamami", hint: "Check my code" },
        { label: "Email", icon: "mail", url: "mailto:rizqi@example.com", hint: "Send a direct message" },
      ],
